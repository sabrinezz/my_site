...
if ( ! class_exists( 'Beauty_Cosmetic_Store_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Beauty_Cosmetic_Store_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Beauty_Cosmetic_Store_WPTT_WebFont_Loader( $url );
