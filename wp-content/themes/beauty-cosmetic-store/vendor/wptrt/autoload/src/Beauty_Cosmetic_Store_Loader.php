...
class Beauty_Cosmetic_Store_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function beauty_cosmetic_store_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function beauty_cosmetic_store_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function beauty_cosmetic_store_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function beauty_cosmetic_store_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->beauty_cosmetic_store_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function beauty_cosmetic_store_load( $class ) {
