...
class Beauty_Cosmetic_Store_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function beauty_cosmetic_store_loadClassLoader($class)
    {
    ...
    public static function beauty_cosmetic_store_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
