...
<?php if(get_theme_mod('beauty_cosmetic_store_preloader_hide','')){ ?>
    <div class="loading">
        <div class="dot"></div>
        <div class="dot"></div>
        <div class="dot"></div>
...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#skip-content"><?php esc_html_e('Skip to content', 'beauty-cosmetic-store'); ?></a>
    <header id="masthead" class="site-header navbar-dark bg-primary">
        <div class="socialmedia">
            ...
            <div class="header-main-box">
                <?php get_template_part('template-parts/topheader/middle-header'); ?>
